...
pub fn draw_rec(pos: V2, w: i32, h: i32, color: Color) {
    debug_assert!(w % 2 == 0);
    debug_assert!(h % 2 == 0);
...
pub fn draw_rec_top_left(pos: V2, w: i32, h: i32, color: Color) {
    draw_rectangle(pos.x() as f32, pos.y() as f32, w as f32, h as f32, color);
}

pub fn copy_texture(texture: &Texture2D, pos: V2) {
    texture.set_filter(FilterMode::Nearest);
    draw_texture(texture, pos.x() as f32 - texture.width() * 0.50, pos.y() as f32 - texture.height() * 0.50, WHITE);
}

pub fn copy_with_rotation(texture: &Texture2D, pos: V2, rotation: f64) {
    texture.set_filter(FilterMode::Nearest);
